...
SIGNAL EN_DAC_DATA_REG	: STD_LOGIC;
...
TYPE STATE_TYPE IS (INIT, REF_ENABLE, SCLK_REF_HIGH, SCLK_REF_LOW, DATA_INIT, DATA_LOAD, DAC_DATA_LOAD, SCLK_DATA_HIGH, SCLK_DATA_LOW, TWAIT, DATA_NEW_WAIT);
		...
		ELSIF (CLOCK = '1' AND CLOCK'EVENT) THEN
			...
			CASE STATE IS
				...
				WHEN SCLK_REF_LOW => IF SCLK_DIV_CNT = "1111" THEN 
												IF SCLK_CNT = "11111" THEN STATE <= DAC_DATA_LOAD; 
												ELSE STATE <= SCLK_REF_HIGH;
												END IF;
											ELSE STATE <= SCLK_REF_LOW;
											END IF;
											
				WHEN DAC_DATA_LOAD	=> STATE <= DATA_INIT;
...
SYNC <= '0' WHEN STATE = REF_ENABLE OR STATE = SCLK_REF_HIGH OR STATE = SCLK_REF_LOW OR STATE = DATA_LOAD OR STATE = DAC_DATA_LOAD OR 
...
EN_DAC_DATA_REG <= '1' WHEN STATE = DAC_DATA_LOAD ELSE '0';
