...
// JAL moved after gen_rgmii_txd_oddr
genvar ox;
...
//wire [4:0] rgmii_rx_clk_bufio; // changed to be a 5 bit wire
...
//);
// JAL, direct assign to avoid error? Seems to be working...
assign rgmii_rx_clk_bufio = rgmii_rx_clk_buf;
