...
(
     ...
     output            lb_valid,
     output            lb_rnw,
     output [23:0]     lb_addr,		//Data flow through FPGA appears to be driven by this variable, this might be getting messed up when the SFP is having issues leading to data errors in HPA operation.
...
localparam IPADDR = {8'd192, 8'd168, 8'd50, 8'd109};
localparam MACADDR = 48'h00105ad155b3;
