...
// 192.168.50.111 is IP for LLRF 3.0 Interlocks
// h00105ad155b6
localparam IPADDR = {8'd192, 8'd168, 8'd50, 8'd111};
localparam MACADDR = 48'h00105ad155b6;

//BNL Eval 
//localparam IPADDR = {8'd10, 8'd34, 8'd32, 8'd54};
//localparam MACADDR = 48'h0050C2611181;  
...
i_eth_gtx_bridge (
     ...
     .lb_valid          (lb_valid),
     .lb_rnw            (lb_rnw),
     .lb_addr           (lb_addr), // set to lb_addr_raw if lag is desired
     .lb_wdata          (lb_wdata),
