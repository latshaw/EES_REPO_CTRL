//altasmi_parallel CBX_AUTO_BLACKBOX="ALL" CBX_SINGLE_OUTPUT_FILE="ON" DATA_WIDTH="STANDARD" DEVICE_FAMILY="Cyclone 10 GX" ENABLE_SIM="FALSE" EPCS_TYPE="MT25QU01G" FLASH_RSTPIN="FALSE" PAGE_SIZE=128 PORT_BULK_ERASE="PORT_UNUSED" PORT_DIE_ERASE="PORT_UNUSED" PORT_EN4B_ADDR="PORT_USED" PORT_EX4B_ADDR="PORT_UNUSED" PORT_FAST_READ="PORT_UNUSED" PORT_ILLEGAL_ERASE="PORT_USED" PORT_ILLEGAL_WRITE="PORT_USED" PORT_RDID_OUT="PORT_UNUSED" PORT_READ_ADDRESS="PORT_UNUSED" PORT_READ_DUMMYCLK="PORT_UNUSED" PORT_READ_RDID="PORT_UNUSED" PORT_READ_SID="PORT_UNUSED" PORT_READ_STATUS="PORT_UNUSED" PORT_SECTOR_ERASE="PORT_USED" PORT_SECTOR_PROTECT="PORT_UNUSED" PORT_SHIFT_BYTES="PORT_USED" PORT_WREN="PORT_USED" PORT_WRITE="PORT_USED" USE_ASMIBLOCK="ON" USE_EAB="OFF" WRITE_DUMMY_CLK=0 addr busy clkin data_valid datain dataout en4b_addr illegal_erase illegal_write rden read reset sce sector_erase shift_bytes wren write INTENDED_DEVICE_FAMILY="Cyclone 10 GX" ALTERA_INTERNAL_OPTIONS=SUPPRESS_DA_RULE_INTERNAL=C106
//VERSION_BEGIN 18.1 cbx_a_gray2bin 2018:08:19:08:04:10:SJ cbx_a_graycounter 2018:08:19:08:04:10:SJ cbx_altasmi_parallel 2018:08:19:08:04:10:SJ cbx_altdpram 2018:08:19:08:04:10:SJ cbx_altera_counter 2018:08:19:08:04:10:SJ cbx_altera_syncram 2018:08:19:08:04:10:SJ cbx_altera_syncram_nd_impl 2018:08:19:08:04:10:SJ cbx_altsyncram 2018:08:19:08:04:10:SJ cbx_arriav 2018:08:19:08:04:10:SJ cbx_fifo_common 2018:08:19:08:04:10:SJ cbx_lpm_add_sub 2018:08:19:08:04:10:SJ cbx_lpm_compare 2018:08:19:08:04:10:SJ cbx_lpm_counter 2018:08:19:08:04:10:SJ cbx_lpm_decode 2018:08:19:08:04:10:SJ cbx_lpm_mux 2018:08:19:08:04:10:SJ cbx_mgl 2018:08:19:08:04:50:SJ cbx_nadder 2018:08:19:08:04:10:SJ cbx_nightfury 2018:08:19:08:04:10:SJ cbx_scfifo 2018:08:19:08:04:10:SJ cbx_stratix 2018:08:19:08:04:10:SJ cbx_stratixii 2018:08:19:08:04:10:SJ cbx_stratixiii 2018:08:19:08:04:10:SJ cbx_stratixv 2018:08:19:08:04:10:SJ cbx_util_mgl 2018:08:19:08:04:10:SJ cbx_zippleback 2018:08:19:08:04:10:SJ  VERSION_END
...
//synthesis_resources = a_graycounter 4 cyclone10gx_asmiblock 1 lpm_compare 2 lpm_counter 3 lut 1217 mux21 1 reg 151 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"SUPPRESS_DA_RULE_INTERNAL=C106"} *)
module  epcs_altera_asmi_parallel_181_35zkgoa
	( 
	addr,
	busy,
	clkin,
...
`endif
	...
	wire	[2:0]	wire_ncs_reg_d;
	reg	[2:0]	ncs_reg;
	wire	[2:0]	wire_ncs_reg_sclr;
	...
	wire  wire_cmpr4_aeb;
	wire  wire_cmpr5_aeb;
	wire  [7:0]   wire_pgwr_data_cntr_q;
	wire  [7:0]   wire_pgwr_read_cntr_q;
	wire  [32:0]   wire_read_add_cntr_q;
	wire	wire_mux211_dataout;
	wire  [7:0]   wire_scfifo3_q;
	wire  wire_sd2_data0in;
	wire  wire_sd2_data1in;
	wire  wire_sd2_data2in;
	wire  wire_sd2_data3in;
	wire  add_rollover;
	wire  addr_die_diff;
	wire  addr_overdie;
	...
	wire  load_opcode;
	wire  [10:0]  mask_prot;
	wire  [10:0]  mask_prot_add;
	wire  [10:0]  mask_prot_check;
	wire  [10:0]  mask_prot_comp_ntb;
	wire  [10:0]  mask_prot_comp_tb;
	wire  memadd_sdoin;
	wire  ncs_reg_ena_wire;
	wire  not_busy;
	wire  oe_wire;
	wire  [7:0]  page_size_wire;
	wire  [7:0]  pagewr_buf_not_empty;
	wire  [15:0]  prot_wire;
	wire  rden_wire;
	...
	( 
	.aclr(reset),
	.clk_en(((((((((((((((in_operation & end_one_cycle) & (~ (stage3_wire & (~ end_add_cycle)))) & (~ (stage4_wire & (~ end_read)))) & (~ (stage4_wire & (~ end_fast_read)))) & (~ ((((do_write | do_sec_erase) | do_die_erase) | do_bulk_erase) & write_prot_true))) & (~ (do_write & (~ pagewr_buf_not_empty[7])))) & (~ (stage3_wire & st_busy_wire))) & (~ ((do_write & shift_pgwr_data) & (~ end_pgwr_data)))) & (~ (stage2_wire & do_wren))) & (~ ((((stage3_wire & (do_sec_erase | do_die_erase)) & (~ do_wren)) & (~ do_read_stat)) & (~ do_read_rdid)))) & (~ (stage3_wire & ((do_write_volatile | do_read_volatile) | do_read_nonvolatile)))) | ((stage3_wire & do_fast_read) & do_wait_dummyclk)) | addr_overdie) | end_ophdly)),
	.clock(clkin_wire),
	.q(wire_stage_cntr_q),
	.qbin(),
	.sclr((end_operation | addr_overdie))
	...
	always @ ( negedge clkin_wire or  posedge reset)
		...
		else  add_rollover_reg <= (wire_read_add_cntr_q[27] | clr_read_wire2);
	// synopsys translate_off
	initial
		addr_die_diff_reg = 0;
	// synopsys translate_on
	...
	assign
		wire_addr_reg_ena = {32{((((rden_wire | wren_wire) & not_busy) | (stage4_wire & addr_overdie)) | (stage3_wire & ((((do_write | do_sec_erase) | do_die_erase) & do_memadd) | (do_read | do_fast_read))))}};
	// synopsys translate_off
	initial
	...
	// synopsys translate_on
	always @ ( negedge clkin_wire or  posedge reset)
		if (reset == 1'b1) ncs_reg[0:0] <= 1'b0;
		else if  (ncs_reg_ena_wire == 1'b1) 
			if (wire_ncs_reg_sclr[0:0] == 1'b1) ncs_reg[0:0] <= 1'b0;
			else  ncs_reg[0:0] <= wire_ncs_reg_d[0:0];
	// synopsys translate_off
	initial
		ncs_reg[1:1] = 0;
	// synopsys translate_on
	always @ ( negedge clkin_wire or  posedge reset)
		if (reset == 1'b1) ncs_reg[1:1] <= 1'b0;
		else if  (ncs_reg_ena_wire == 1'b1) 
			if (wire_ncs_reg_sclr[1:1] == 1'b1) ncs_reg[1:1] <= 1'b0;
			else  ncs_reg[1:1] <= wire_ncs_reg_d[1:1];
	// synopsys translate_off
	initial
		ncs_reg[2:2] = 0;
	// synopsys translate_on
	always @ ( negedge clkin_wire or  posedge reset)
		if (reset == 1'b1) ncs_reg[2:2] <= 1'b0;
		else if  (ncs_reg_ena_wire == 1'b1) 
			if (wire_ncs_reg_sclr[2:2] == 1'b1) ncs_reg[2:2] <= 1'b0;
			else  ncs_reg[2:2] <= wire_ncs_reg_d[2:2];
	assign
		wire_ncs_reg_d = {((sce[2] & (~ sce[1])) & (~ sce[0])), (((~ sce[2]) & sce[1]) & (~ sce[0])), ((~ sce[2]) & (~ sce[1]))};
	assign
		wire_ncs_reg_sclr = {3{(end_operation | addr_overdie_pos)}};
	// synopsys translate_off
	initial
	...
	always @ ( negedge clkin_wire or  posedge reset)
		if (reset == 1'b1) write_prot_reg <= 1'b0;
			...
			else  write_prot_reg <= ((((do_write | do_sec_erase) & (~ prot_wire[0])) & (((~ mask_prot_comp_ntb[10]) & (~ tb_wire)) | ((~ mask_prot_comp_tb[10]) & tb_wire))) | be_write_prot);
	assign
	...
	.aleb(),
	.aneb(),
	.dataa({page_size_wire[7:0]}),
	.datab({wire_pgwr_data_cntr_q[7:0]})
	`ifndef FORMAL_VERIFICATION
	// synopsys translate_off
	`endif
	,
	...
	.aleb(),
	.aneb(),
	.dataa({wire_pgwr_data_cntr_q[7:0]}),
	.datab({wire_pgwr_read_cntr_q[7:0]})
	`ifndef FORMAL_VERIFICATION
	// synopsys translate_off
	`endif
	,
	...
	assign		wire_mux211_dataout = (do_fast_read === 1'b1) ? end_add_cycle_mux_datab_wire : ((wire_addbyte_cntr_q[2] & wire_addbyte_cntr_q[1]) & (~ wire_addbyte_cntr_q[0]));
	scfifo   scfifo3
	( 
	.aclr(reset),
	.almost_empty(),
	...
	assign
		...
		dataout_wire = {wire_sd2_data3in, wire_sd2_data2in, wire_sd2_data1in, wire_sd2_data0in},
		...
		illegal_write_b4out_wire = ((do_write & write_prot_true) | (do_write & (~ pagewr_buf_not_empty[7]))),
		...
		mask_prot_add = {(mask_prot[10] & addr_reg[26]), (mask_prot[9] & addr_reg[25]), (mask_prot[8] & addr_reg[24]), (mask_prot[7] & addr_reg[23]), (mask_prot[6] & addr_reg[22]), (mask_prot[5] & addr_reg[21]), (mask_prot[4] & addr_reg[20]), (mask_prot[3] & addr_reg[19]), (mask_prot[2] & addr_reg[18]), (mask_prot[1] & addr_reg[17]), (mask_prot[0] & addr_reg[16])},
		mask_prot_check = {(mask_prot[10] ^ mask_prot_add[10]), (mask_prot[9] ^ mask_prot_add[9]), (mask_prot[8] ^ mask_prot_add[8]), (mask_prot[7] ^ mask_prot_add[7]), (mask_prot[6] ^ mask_prot_add[6]), (mask_prot[5] ^ mask_prot_add[5]), (mask_prot[4] ^ mask_prot_add[4]), (mask_prot[3] ^ mask_prot_add[3]), (mask_prot[2] ^ mask_prot_add[2]), (mask_prot[1] ^ mask_prot_add[1]), (mask_prot[0] ^ mask_prot_add[0])},
		mask_prot_comp_ntb = {(mask_prot_check[10] | mask_prot_comp_ntb[9]), (mask_prot_check[9] | mask_prot_comp_ntb[8]), (mask_prot_check[8] | mask_prot_comp_ntb[7]), (mask_prot_check[7] | mask_prot_comp_ntb[6]), (mask_prot_check[6] | mask_prot_comp_ntb[5]), (mask_prot_check[5] | mask_prot_comp_ntb[4]), (mask_prot_check[4] | mask_prot_comp_ntb[3]), (mask_prot_check[3] | mask_prot_comp_ntb[2]), (mask_prot_check[2] | mask_prot_comp_ntb[1]), (mask_prot_check[1] | mask_prot_comp_ntb[0]), mask_prot_check[0]},
		mask_prot_comp_tb = {(mask_prot_add[10] | mask_prot_comp_tb[9]), (mask_prot_add[9] | mask_prot_comp_tb[8]), (mask_prot_add[8] | mask_prot_comp_tb[7]), (mask_prot_add[7] | mask_prot_comp_tb[6]), (mask_prot_add[6] | mask_prot_comp_tb[5]), (mask_prot_add[5] | mask_prot_comp_tb[4]), (mask_prot_add[4] | mask_prot_comp_tb[3]), (mask_prot_add[3] | mask_prot_comp_tb[2]), (mask_prot_add[2] | mask_prot_comp_tb[1]), (mask_prot_add[1] | mask_prot_comp_tb[0]), mask_prot_add[0]},
		...
		oe_wire = 1'b0,
		page_size_wire = 8'b10000000,
		pagewr_buf_not_empty = {(pagewr_buf_not_empty[6] | wire_pgwr_data_cntr_q[7]), (pagewr_buf_not_empty[5] | wire_pgwr_data_cntr_q[6]), (pagewr_buf_not_empty[4] | wire_pgwr_data_cntr_q[5]), (pagewr_buf_not_empty[3] | wire_pgwr_data_cntr_q[4]), (pagewr_buf_not_empty[2] | wire_pgwr_data_cntr_q[3]), (pagewr_buf_not_empty[1] | wire_pgwr_data_cntr_q[2]), (pagewr_buf_not_empty[0] | wire_pgwr_data_cntr_q[1]), wire_pgwr_data_cntr_q[0]},
...
endmodule //epcs_altera_asmi_parallel_181_35zkgoa
//VALID FILE
