...
//synthesis_resources = a_graycounter 4 cyclone10gx_asmiblock 1 lpm_compare 2 lpm_counter 3 lut 29 mux21 2 reg 155 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"SUPPRESS_DA_RULE_INTERNAL=C106"} *)
module  epcs_altera_asmi_parallel_181_a5aieiq
	( 
	addr,
	busy,
	clkin,
...
`endif
	...
	wire  wire_sd3_data0in;
	wire  wire_sd3_data1in;
	wire  wire_sd3_data2in;
	wire  wire_sd3_data3in;
	wire  add_rollover;
	wire  addr_die_diff;
	wire  addr_overdie;
	...
	assign		wire_mux212_dataout = (do_fast_read === 1'b1) ? end_add_cycle_mux_datab_wire : ((wire_addbyte_cntr_q[2] & wire_addbyte_cntr_q[1]) & (~ wire_addbyte_cntr_q[0]));
	scfifo   scfifo4
	( 
	.aclr(reset),
	.almost_empty(),
	...
	defparam
		sd3.enable_sim = "false",
		sd3.lpm_type = "cyclone10gx_asmiblock";
	assign
		...
		dataout_wire = {wire_sd3_data3in, wire_sd3_data2in, wire_sd3_data1in, wire_sd3_data0in},
...
endmodule //epcs_altera_asmi_parallel_181_a5aieiq
//VALID FILE
