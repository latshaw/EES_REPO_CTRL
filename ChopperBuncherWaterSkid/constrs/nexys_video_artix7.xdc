...
## Clock Signal
set_property -dict {PACKAGE_PIN R4 IOSTANDARD LVCMOS33} [get_ports SYSCLK_P]
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports SYSCLK_P]
...
set_property -dict {PACKAGE_PIN U7 IOSTANDARD LVCMOS33} [get_ports PHY_RSTN]
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS25} [get_ports RGMII_RX_CLK]
set_property -dict {PACKAGE_PIN W10 IOSTANDARD LVCMOS25} [get_ports RGMII_RX_CTRL]
...
set_property -dict {PACKAGE_PIN AA14 IOSTANDARD LVCMOS25} [get_ports RGMII_TX_CLK]
set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS25} [get_ports RGMII_TX_CTRL]
set_property -dict {PACKAGE_PIN Y12 IOSTANDARD LVCMOS25} [get_ports {RGMII_TXD[0]}]
set_property -dict {PACKAGE_PIN W12 IOSTANDARD LVCMOS25} [get_ports {RGMII_TXD[1]}]
set_property -dict {PACKAGE_PIN W11 IOSTANDARD LVCMOS25} [get_ports {RGMII_TXD[2]}]
set_property -dict {PACKAGE_PIN Y11 IOSTANDARD LVCMOS25} [get_ports {RGMII_TXD[3]}]
...
#set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS18 } [get_ports { fmc_la00_cc_n }]; #IO_L13N_T2_MRCC_15 Sch=fmc_la00_cc_n
...
set_property -dict {PACKAGE_PIN D17 IOSTANDARD LVCMOS33} [get_ports SLOT1_CSn[0]]
set_property -dict {PACKAGE_PIN H22 IOSTANDARD LVCMOS33} [get_ports SLOT1_CSn[1]]
set_property -dict {PACKAGE_PIN J22 IOSTANDARD LVCMOS33} [get_ports SLOT1_CSn[2]]
set_property -dict {PACKAGE_PIN K22 IOSTANDARD LVCMOS33} [get_ports SLOT1_CSn[3]]
set_property -dict {PACKAGE_PIN K21 IOSTANDARD LVCMOS33} [get_ports SLOT1_SCLK]
set_property -dict {PACKAGE_PIN M22 IOSTANDARD LVCMOS33} [get_ports SLOT1_MOSI]
set_property -dict {PACKAGE_PIN N22 IOSTANDARD LVCMOS33} [get_ports SLOT1_MISO]

set_property -dict {PACKAGE_PIN N18 IOSTANDARD LVCMOS33} [get_ports SLOT2_CSn[0]]
set_property -dict {PACKAGE_PIN N19 IOSTANDARD LVCMOS33} [get_ports SLOT2_CSn[1]]
set_property -dict {PACKAGE_PIN M15 IOSTANDARD LVCMOS33} [get_ports SLOT2_CSn[2]]
set_property -dict {PACKAGE_PIN M16 IOSTANDARD LVCMOS33} [get_ports SLOT2_CSn[3]]
set_property -dict {PACKAGE_PIN L19 IOSTANDARD LVCMOS33} [get_ports SLOT2_SCLK]
set_property -dict {PACKAGE_PIN L20 IOSTANDARD LVCMOS33} [get_ports SLOT2_MOSI]
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports SLOT2_MISO]

set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports SLOT3_CSn[0]]
set_property -dict {PACKAGE_PIN L18 IOSTANDARD LVCMOS33} [get_ports SLOT3_CSn[1]]
set_property -dict {PACKAGE_PIN N20 IOSTANDARD LVCMOS33} [get_ports SLOT3_CSn[2]]
set_property -dict {PACKAGE_PIN M20 IOSTANDARD LVCMOS33} [get_ports SLOT3_CSn[3]]
set_property -dict {PACKAGE_PIN M13 IOSTANDARD LVCMOS33} [get_ports SLOT3_SCLK]
set_property -dict {PACKAGE_PIN L13 IOSTANDARD LVCMOS33} [get_ports SLOT3_MOSI]
set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33} [get_ports SLOT3_MISO]

set_property -dict {PACKAGE_PIN E21 IOSTANDARD LVCMOS33} [get_ports SLOT4_CSn[0]]
set_property -dict {PACKAGE_PIN D21 IOSTANDARD LVCMOS33} [get_ports SLOT4_CSn[1]]
set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS33} [get_ports SLOT4_CSn[2]]
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS33} [get_ports SLOT4_CSn[3]]
set_property -dict {PACKAGE_PIN C14 IOSTANDARD LVCMOS33} [get_ports SLOT4_SCLK]
set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS33} [get_ports SLOT4_MOSI]
set_property -dict {PACKAGE_PIN E13 IOSTANDARD LVCMOS33} [get_ports SLOT4_MISO]

set_property -dict {PACKAGE_PIN A20 IOSTANDARD LVCMOS33} [get_ports LED_SCL]
set_property -dict {PACKAGE_PIN B20 IOSTANDARD LVCMOS33} [get_ports LED_SDA]

set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVCMOS33} [get_ports SENSE24]
set_property -dict {PACKAGE_PIN A19 IOSTANDARD LVCMOS33} [get_ports DRIVE24[0]]
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVCMOS33} [get_ports DRIVE24[1]]
set_property -dict {PACKAGE_PIN D19 IOSTANDARD LVCMOS33} [get_ports DRIVE24[2]]
set_property -dict {PACKAGE_PIN B15 IOSTANDARD LVCMOS33} [get_ports DRIVE24[3]]
#set_property -dict {PACKAGE_PIN B16 IOSTANDARD LVCMOS33} [get_ports SPARE_6]
#set_property -dict {PACKAGE_PIN C13 IOSTANDARD LVCMOS33} [get_ports SPARE_7]
#set_property -dict {PACKAGE_PIN B13 IOSTANDARD LVCMOS33} [get_ports SPARE_8]
#set_property -dict {PACKAGE_PIN A13 IOSTANDARD LVCMOS33} [get_ports SPARE_9]
...
#set_property PULLDOWN true [get_ports ADC1_RST]
#set_property PULLDOWN true [get_ports ADC1_nCNVST]
#set_property PULLDOWN true [get_ports ADC1_nCS]
#set_property PULLDOWN true [get_ports ADC2_RST]
#set_property PULLDOWN true [get_ports ADC2_nCNVST]
#set_property PULLDOWN true [get_ports ADC2_nCS]
#set_property PULLDOWN true [get_ports ADC3_RST]
#set_property PULLDOWN true [get_ports ADC3_nCNVST]
#set_property PULLDOWN true [get_ports ADC3_nCS]
#set_property PULLDOWN true [get_ports ADC4_RST]
#set_property PULLDOWN true [get_ports ADC4_nCNVST]
#set_property PULLDOWN true [get_ports ADC4_nCS]

#set_output_delay -clock CLOCK -max 10 [get_ports ADC1_RST]
#set_output_delay -clock CLOCK -min 4 [get_ports ADC1_RST]
#set_output_delay -clock CLOCK -max 10 [get_ports ADC2_RST]
#set_output_delay -clock CLOCK -min 4 [get_ports ADC2_RST]
#set_output_delay -clock CLOCK -max 10 [get_ports ADC3_RST]
#set_output_delay -clock CLOCK -min 4 [get_ports ADC3_RST]
#set_output_delay -clock CLOCK -max 10 [get_ports ADC4_RST]
#set_output_delay -clock CLOCK -min 4 [get_ports ADC4_RST]
