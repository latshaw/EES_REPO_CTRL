...
BEGIN
	...
	gen_counter_normal1 : if testBench = '0' generate
		...
		count_FULL	<= x"07735940"; -- 100 Mhz value 0098967F, 125 Mhz values   005F5E10
		count_Half	<= x"03B9ACA0"; -- 100 Mhz value 004C4B40, 125 Mhz values   002FAF08
	...
	--
	ADDR_LED <= "0100000"; -- based on physical pull ups/pull downs and chip specifics
	--
	--===================================================
	--		Main Process
	--===================================================
