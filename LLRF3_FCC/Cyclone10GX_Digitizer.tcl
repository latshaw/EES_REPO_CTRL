...
# Generated on: Wed Jan 24 15:37:59 2024
...
if {$make_assignments} {
	...
	set_global_assignment -name SDC_FILE cyclone10gx_digitizer_main.sdc
	...
	set_global_assignment -name VERILOG_FILE pdetect.v
	set_global_assignment -name VHDL_FILE beam_permit.vhd
	set_global_assignment -name VHDL_FILE hb_isa.vhd
	set_global_assignment -name VHDL_FILE ad9781_sample_seek.vhd
	set_global_assignment -name VHDL_FILE harv_trig_delay.vhd
	set_global_assignment -name VHDL_FILE cirbufh_data.vhd
	set_global_assignment -name VHDL_FILE reset_all.vhd
	set_global_assignment -name VHDL_FILE cirbufs_takei.vhd
	set_global_assignment -name VHDL_FILE beam_permit_magphs.vhd
	set_global_assignment -name VHDL_FILE gmesfault.vhd
	set_global_assignment -name VHDL_FILE lopwfault.vhd
	...
	set_location_assignment PIN_B14 -to lmk03328_scl
	set_location_assignment PIN_A14 -to lmk03328_sda
	set_location_assignment PIN_F19 -to ad9781_ncs
	set_location_assignment PIN_F18 -to ad9781_rst
	set_location_assignment PIN_E16 -to ad9781_sdo
	set_location_assignment PIN_C13 -to ad9781_sclk
	set_location_assignment PIN_F16 -to ad9781_sdi
	set_location_assignment PIN_B15 -to ad9653_pwdn
	...
	set_location_assignment PIN_B11 -to ad9653_sdio_dir
